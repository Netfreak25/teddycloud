...
request_type_t request_paths[] = {
    ...
    {REQ_POST, "/api/library/native/delete", SERTY_WEB, &handleApiNativeLibraryDelete},
    ...
    {REQ_POST, "/api/tonie/metadata/", SERTY_WEB, &handleApiTonieMetadata},
    {REQ_POST, "/api/tonie/image/upload/", SERTY_WEB, &handleApiTonieImageUpload},
    {REQ_POST, "/api/tonie/image/remove/", SERTY_WEB, &handleApiTonieImageRemove},
    {REQ_GET, "/api/tonie/image/", SERTY_WEB, &handleApiTonieImage},
